 ...
 *
 * @license MIT
 */function  (e,t,n,r){"use strict";var o,i,u,c;Object.defineProperty(t,"__esModule",{value:!0}),function(e,t){for(var n in t)Object.defineProperty(e,n,{enumerable:!0,get:t[n]});}(t,{BrowserRouter:function(){return m;},Route:function(){return l.Route;},Routes:function(){return l.Routes;},useLocation:function(){return l.useLocation;},useNavigate:function(){return l.useNavigate;}});let s=n("@swc/helpers/_/_interop_require_wildcard")._(n("2259d9ae")),l=n("e7dfd773"),d=n("57fc19da"),w=new Set(["application/x-www-form-urlencoded","multipart/form-data","text/plain"]);try{window.__reactRouterVersion="6";}catch(e){}let f=s.startTransition;function m(e){let{basename:t,children:n,future:r,window:o}=e,i=s.useRef();null==i.current&&(i.current=(0,d.createBrowserHistory)({window:o,v5Compat:!0}));let u=i.current,[c,w]=s.useState({action:u.action,location:u.location}),{v7_startTransition:m}=r||{},R=s.useCallback(e=>{m&&f?f(()=>w(e)):w(e);},[w,m]);return s.useLayoutEffect(()=>u.listen(R),[u,R]),s.createElement(l.Router,{basename:t,children:n,location:c.location,navigationType:c.action,navigator:u,future:r});}"undefined"!=typeof window&&void 0!==window.document&&window.document.createElement,(u=o||(o={})).UseScrollRestoration="useScrollRestoration",u.UseSubmit="useSubmit",u.UseSubmitFetcher="useSubmitFetcher",u.UseFetcher="useFetcher",u.useViewTransitionState="useViewTransitionState",(c=i||(i={})).UseFetcher="useFetcher",c.UseFetchers="useFetchers",c.UseScrollRestoration="useScrollRestoration";let R=0;},"c85d2dfa":function  (e,t,r,u){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),Object.defineProperty(t,"default",{enumerable:!0,get:function(){return n;}});let n=r("@swc/helpers/_/_interop_require_default")._(r("82148f4d")).default;},"c87a9287":function  (t,e,s,c){"use strict";t.exports=s("786eda13",!0);},});